def tennisSet(score1, score2):
    ...
    if maxi == mini:
        ...
        return False
    elif maxi > 6 and maxi-mini > 2:
        return False
    elif maxi == 6 and maxi-mini == 1:
        return False
    return True
...
declared the winner unless their opponent had already won 5 games, in which case the set continues until one
of the players has won 7 games.
