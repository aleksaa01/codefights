...
binary representations (it is guaranteed that such a pair exists), counting from right to left.
...
1010 = 10102, 1110 = 10112, the position of the rightmost pair of equal bits is the bit at
