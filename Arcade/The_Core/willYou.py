def willYou(young, beautiful, loved):
    if young is True and beautiful is True and loved is False:
        return True
    elif loved is True and (young is False or beautiful is False):
        return True
    return False
...
"Will you still love me when I'm no longer young and beautiful?". Mary believes that a person
is loved if and only if he/she is both young and beautiful, but this is quite a depressing thought,
