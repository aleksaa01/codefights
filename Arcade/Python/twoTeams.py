def twoTeams(students):
    return sum(i for c, i in enumerate(students) if c % 2 == 0) - sum(i for c, i in enumerate(students) if c % 2 != 0)
...
The students are about to divide into two teams by counting off by twos: those standing at the even positions
(0-based) will go to team A, and those standing at the odd position will join the team B.
