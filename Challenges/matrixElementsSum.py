def matrixElementsSum(matrix):
    haunted = [False] * len(matrix[0])  # faster then appending or using sets or dictionaries.
    res = 0
...
CodeBots are quite superstitious, they refuse to stay in any of the free rooms, or any of the rooms
...
task is to return the total sum of all rooms that are suitable for the CodeBots (ie: add up all the values
