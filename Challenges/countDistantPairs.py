...
"""
Given a string inputString and an integer distance, find the number of pairs of equal characters in the inputString
delimited by exactly distance characters.
